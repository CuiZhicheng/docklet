...
class Worker(object):
    def __init__(self, etcdclient, addr, port):
        ...
        self.rpcserver.register_function(netcontrol.add_container_network)
        self.rpcserver.register_function(netcontrol.del_container_network)
        self.rpcserver.register_function(netcontrol.del_user_network)
